...
import {
  getEvents,
  setEvent,
  clearEvents as ClearLclStorage,
...
export const WatchContext = React.createContext<WatchContextValues>(
  null as any
);

export const WatchEventsProvider = ({
  children,
  value,
}: {
  children?: React.ReactNode;
  value?: WatchContextValues;
}) => {
  ...
  return (
    <WatchContext.Provider
      value={{ ...value, setEvents, events: eventState, clearEvents }}
    >
      {children}
    </WatchContext.Provider>
  );
