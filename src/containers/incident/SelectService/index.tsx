...
const SelectServices = React.forwardRef<HTMLDivElement, HTMLProps<HTMLDivElement>>((props, ref) => {
   const { integration, setCurrentStep, setSelectedCollection, domain,current, selectedOrganization = 'default' } = React.useContext(AppContext);
   ...
   const getAllTickets = async () => {
      setLoading(true);
      try {
         const resp = await API.services.getServicesOpsigine(selectedOrganization, { integrationId: integration?.id } ,domain);
